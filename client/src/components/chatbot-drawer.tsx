  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Olá! Sou a assistente da JuPhD Care. Posso tirar dúvidas sobre saúde mental no trabalho, riscos psicossociais ou ajudar você a entender seus sentimentos. Como posso ajudar?",
    },
  ]);
